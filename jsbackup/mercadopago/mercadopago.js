...
loadJsAsync("//code.jquery.com/jquery-1.11.0.min.js", function () {
    ...
    loadJsAsync("https://secure.mlstatic.com/org-img/checkout/custom/1.0/checkout.js?nocache=" + Math.random() * 10, function () {
        ...
        Checkout.setPublishableKey("APP_USR-a97fe0b7-595e-4e6c-8c28-f04aff5ae7c5");
        //end load mp
    });
    ...
    loadJsAsync("//code.jquery.com/jquery-1.11.0.min.js", function () {
      $.noConflict();
        jQuery(document).ready(function($) {
            ...
            var choice_text_mercadopago = "Cantidad de cuotas";
            ...
            function showIssuers(status, issuers){
                ...
                if (issuers.length == 1) {
                    ...
                    var options = '<select name="payment[issuers]" id="issuers" data-checkout="issuers" class="input-text fixwidth stateselect" autocomplete="off">'
                    options += '<option value="-1">' + "Banco" + '...</option>';
