...
function Node(dir, id, pid, name, url, title, target, icon, iconOpen, open) {
...
function dTree(objName) {
	...
	this.iconrtl = {
		...
		line				: baseUrl + 'img/linertl.gif',

		join				: baseUrl + 'img/joinrtl.gif',

		joinBottom	: baseUrl + 'img/joinbottomrtl.gif',

		plus				: baseUrl + 'img/plusrtl.gif',

		plusBottom	: baseUrl + 'img/plusbottomrtl.gif',

		minus				: baseUrl + 'img/minusrtl.gif',

		minusBottom	: baseUrl + 'img/minusbottomrtl.gif',
...
dTree.prototype.add = function(dir, id, pid, name, url, title, target, icon, iconOpen, open) {
	this.aNodes[this.aNodes.length] = new Node(dir, id, pid, name, url, title, target, icon, iconOpen, open);
